...
<div class="row">
    <div class="col-8">
        <h3 class="font-weight-bolder"><i class='fas fa-shopping-cart'></i> Cicilan Pembelian</h3>
    </div>
...
<div class="wrapper">
    <form action="process/action?url=cicilanpembelian&page=<?= $page ?>" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="no_po" name="no_po" value="<?= $no_po; ?>" readonly>
            </div>
        </div>
        <div class="form-group row">
